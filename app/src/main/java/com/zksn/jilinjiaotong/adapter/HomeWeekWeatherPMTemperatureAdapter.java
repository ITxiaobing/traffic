...
public class HomeWeekWeatherPMTemperatureAdapter extends BaseAdapter {
    private ArrayList<String> mWeekWeatherAMtemperatureLst;
    private Context mContext;

    public HomeWeekWeatherPMTemperatureAdapter(ArrayList<String> mWeekWeatherAMtemperatureLst, Context context) {
